...
#octoprint_key = "7B76970682BA495F93649F8C73EFEADE"
#
#ret = requests.get('http://octopi.local/api/printer', headers={'X-Api-Key': octoprint_key})
#temperatures = ret.json().get('temperature')
